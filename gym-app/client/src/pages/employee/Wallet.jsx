...
const Wallet = () => {
  ...
  const withdraw = async (e) => {
    ...
    try {
      ...
      const reqRes = await api.get('/wallet/withdrawals')
    ...
    <div>
      ...
      <div className="glass p-6 rounded-2xl max-w-lg mb-6">
        ...
        <form onSubmit={withdraw} className="space-y-4">
          ...
          <button type="submit" className="w-full py-2 bg-red-600 hover:bg-red-500 rounded-xl font-semibold">Request</button>
        </form>
      </div>
